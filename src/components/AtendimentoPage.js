...
function AtendimentoPage() {
    ...
    const [dataAtendimentoFinalFilter, setDataAtendimentoFinalFilter] = useState('');
    ...
    function handleFecthEspecialFilterList() {
        if (dataAtendimentoFilter && dataAtendimentoFinalFilter){
            const filter = `dataAtendimento%2Bbetween%2B${encodeURIComponent(dataAtendimentoFilter)}%2B${encodeURIComponent(dataAtendimentoFinalFilter)}`;
            ...
            <div className="d-flex mb-3">
                ...
                <div className="dropdown me-2">
                    ...
                    >
                        {/* Filtro por data */}
                        <div className="p-2">
                            <label className="form-label">Filtrar por data de atendimento</label>
                            <input 
                                type="date" 
                        ...
                        <tbody>
                            {atendimento.produtoAtendimento.map((produtoAtend, index) => (
                                <tr key={produtoAtend.id}>
                                    ...
                                    <td>{produtoAtend.produto.descricao.substring(0, 14)}</td>
                                    <td>{produtoAtend.tipoProduto === 'INTERNACAO' ? 'Internação' :
                                        produtoAtend.tipoProduto === 'PROCEDIMENTO' ? 'Procedimento' :
                                            produtoAtend.tipoProduto === 'REMEDIO' ? 'Remédio' : 'Material'}</td>
